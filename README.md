...
# 🎮 Feed the Scorchpot — Community Edition

**Feed the cauldron, stoke the flames, master the Scorchpot.**
...
Feed the Scorchpot is an indie cooking arcade game where players gather, combine, and toss ingredients into a living cauldron before the flames die down. Escalating heat levels, timed challenges, and escalating recipe demands keep every round tense. This Community Edition is a standalone build of the full game, packaged as a self-contained installer with no additional software required.

This build is for PC players who want a complete, standalone Community Edition of Feed the Scorchpot that runs offline with no storefront required.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3966510/e7010b77c426929dac439b3a7d9d59f320b44820/ss_e7010b77c426929dac439b3a7d9d59f320b44820.1920x1080.jpg?t=1788314377" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3966510/0517a1cede22f77be63d83f60a9c18a2eb69efe0/ss_0517a1cede22f77be63d83f60a9c18a2eb69efe0.1920x1080.jpg?t=1788314377" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3966510/53b2dc423350ab6032c87feaf17991920908b50e/ss_53b2dc423350ab6032c87feaf17991920908b50e.1920x1080.jpg?t=1788314377" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- ✅ **No Steam, itch.io / GOG account required**
- ✅ **No online activation** — works fully offline
- ✅ **Includes all available content**
- ✅ **No launcher bloat** — launch directly from the.exe
- ✅ **Multiplayer support** — Single-player with local co-op; LAN or direct connection supported
...
| **Multiplayer** | Single-player with local co-op; LAN or direct connection supported |
...
- **Interface:** English, French, German, Spanish, Portuguese-Brazil, Japanese, Simplified Chinese
- **Voiceover:** English
...
- 🍲 **Ingredient Crafting** — Combine dozens of ingredients into recipes to keep the Scorchpot fed.
- 🔥 **Escalating Heat System** — Fire intensity rises every round, shrinking your margin for error.
- ⏱️ **Timed Challenge Mode** — Complete recipe quotas against the clock in short arcade sessions.
- 🎨 **Hand-Drawn Art Style** — Fully animated hand-drawn characters and environments.
- 🏆 **Score Chasing** — Local leaderboards track best runs across all modes.
- 🕹️ **Local Co-op** — Two players can share one kitchen in split-input co-op mode.
- 💾 **Offline Play** — The complete game runs entirely offline once installed.
- 🧩 **Recipe Puzzles** — Solve ingredient-combination puzzles to enable new dish types.

- **Compression:** Lossless
- **Install Time:** ~2 minutes on SSD, ~5 minutes on HDD
- **Recoding:** none
- **Selective Download:** Full package; no selective components

---

## 📦 DLCs Included

- Scorchpot: Spicy Season Pack
- Scorchpot: Ember Skin Set
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | Intel HD Graphics 4000 / NVIDIA GeForce GTX 650 | NVIDIA GeForce GTX 1050 Ti / AMD Radeon RX 560 |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\FeedtheScorchpot\Saved`
